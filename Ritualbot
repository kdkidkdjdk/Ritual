...
cat > config.json <<EOF
{
  ...
  "chain": {
    "enabled": true,
    "trail_head_blocks": 5,
    "rpc_url": "https://api.zan.top/node/v1/base/mainnet/c912ffd9a0c84d4cad7cc6e827fc8f9a",
...
function main_menu() {
    clear
    echo "脚本由 绿毛龟 携手 币圈24k纯帅cl 打造"
    echo "================================================================"
    echo "节点社区 Telegram 群组:https://t.me/Yacht_Fleet"
    echo "请选择要执行的操作:"
    echo "1. 安装节点"
    echo "2. 查看节点日志"
    echo "3. 设置快捷键的功能"
